...
from android_world.agents import rnd_agent, bdqn_agent
...
def _get_agent(
  ...
  # RND Agent
  elif _AGENT_NAME.value == 'rnd_agent':
    agent = rnd_agent.RNDAgent(env)
  elif _AGENT_NAME.value == 'bdqn_agent':
    agent = bdqn_agent.BDQNAgent(env)
